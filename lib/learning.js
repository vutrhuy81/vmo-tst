const ACTIONS = new Set([
  ...
  'solution.saved', 'evaluation.saved', 'guide.saved', 'guide.updated', 'guide.deleted', 'submission.deleted',
  'submission.verified', 'submission.verification_revoked', 'submission.content_updated',
