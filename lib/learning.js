const ACTIONS = new Set([
  ...
  'solution.saved', 'evaluation.saved', 'guide.saved', 'submission.deleted',
...
export async function recordActivity(db, session, action, details = {}) {
  ...
  const safeDetails = {};
  for (const key of ['problemKey', 'problemTitle', 'setTitle', 'sourceGroup', 'score', 'submissionId', 'itemTitle']) {
